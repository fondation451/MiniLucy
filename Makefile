LUS_I=ast.cmo ast_lustre.cmo lustre_printer.cmo type.cmo clocking.cmo normalize.cmo parser.cmi parser.cmo lexer.cmo
LUS=ast.cmo ast_lustre.cmo lustre_printer.cmo type.cmo clocking.cmo normalize.cmo parser.cmo lexer.cmo
