LUS_I=ast.cmo ast_lustre.cmo lustre_printer.cmo ast_lustre_to_ast.cmo synchronous_check.cmo parser.cmi parser.cmo lexer.cmo
LUS=ast.cmo ast_lustre.cmo lustre_printer.cmo ast_lustre_to_ast.cmo synchronous_check.cmo parser.cmo lexer.cmo
